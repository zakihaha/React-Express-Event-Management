...
function EventsForm({
    ...
    return (
        <Form onSubmit={handleSubmit} className='mb-2'>
            ...
            <SButton variant='success' type={'button'} action={handlePlusKeyPoint} size='sm'>
                Tambah keypoint
            </SButton>
            ...
            <div className='mb-3'>
                <SButton variant='success' type={'button'} action={handlePlusTicket} size='sm'>
                    Tambah Ticket
                </SButton>
            </div>

            <SButton variant='primary' type={'submit'} loading={loading}>
                {edit ? 'Ubah' : 'Simpan'}
            </SButton>
        </Form>
    );
